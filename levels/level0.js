const level0 = new Level(
    ...
    [
        ...
        new BackgroundObject('img/3. Background/Layers/2. Floor/L2.png', 720),
        new BackgroundObject('img/3. Background/Layers/1. Light/2.png', 720),
        new BackgroundObject('img/8.Instructions/fin_slap.png', 720),
        ...
        new BackgroundObject('img/8.Instructions/collect_items.png', 720 * 2),
        ...
        new BackgroundObject('img/8.Instructions/shoot_bubble.png', 720 * 2.5),
        new BackgroundObject('img/3. Background/Layers/5. Water/D2.png', 720 * 4),
        new BackgroundObject('img/3. Background/Layers/2. Floor/D2.png', 720 * 4),
        new BackgroundObject('img/3. Background/Layers/1. Light/2.png', 720 * 4),
        new BackgroundObject('img/8.Instructions/good_luck.png', 720 * 3 + 300),
